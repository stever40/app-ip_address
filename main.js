 ...
 * @type {Object} 
 *  @property {string} ipv4 Default Gateway in IPv4 syntax.
 *  @property {string} ipv6 Default Gateway in IPv6 syntax.
*/
...
function main() {
  ...
  for (let i = 0; i < sampleCidrsLen; i++) {
    ...
    getFirstIpAddress(sampleCidrs[i], (data, error) => {
      ...
      // console.log(`  Response returned from GET request: ${data.ipv4}`);  // Access object properties directly 
      // console.log(`  Response returned from GET request: %j`, data);  // Old School
